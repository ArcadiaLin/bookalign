...
class BertalignAdapter:
    ...
    def __init__(
        ...
        *,
        ...
        hf_api_token_env: str = 'HF_TOKEN',
        hf_request_timeout: float = 60.0,
        max_align: int = 5,
        top_k: int = 3,
        win: int = 5,
        skip: float = -0.1,
        ...
        self.hf_api_token_env = hf_api_token_env
        self.hf_request_timeout = hf_request_timeout
    ...
    def align(
        ...
        try:
            ...
            vendor.configure_model(
                self.model_name,
                self.device,
                backend=self.model_backend,
                api_url=self.hf_api_url,
                api_token=self.hf_api_token,
                api_token_env=self.hf_api_token_env,
                request_timeout=self.hf_request_timeout,
            )
